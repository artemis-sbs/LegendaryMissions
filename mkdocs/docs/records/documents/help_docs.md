...
1. GATHER the materials. They are carried by the ship, so any console's pickup counts.

1. FABRICATE on Engineering's Fabricate tab. This spends the materials and starts a build timer - the item is not ready immediately.
...
!!! tip "Check the cost before you fly"
