...
> - *(if COMMS_ORIGIN.name)* makes loud mouth noises. Kraliens not listening.
...
> *One of:*
>
> - *(if COMMS_ORIGIN.name)* , the Supreme Understander has decided that you are not capable of intelligent conversation.
